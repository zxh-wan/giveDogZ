...
import top.horsttop.appcore.ui.recyclerview.progressindicator.AVLoadingIndicatorView;
...
public class LoadingMoreFooter extends LinearLayout {
    ...
    public void initView(){
        ...
        mText.setPadding( 0,(int)getResources().getDimension(R.dimen.textandiconmargin),0,0 );
